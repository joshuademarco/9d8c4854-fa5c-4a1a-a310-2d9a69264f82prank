...
unregister-scheduledtask -TaskName "OneDrive ASWG Process Task" -confirm:$false -ErrorAction SilentlyContinue
...
Register-ScheduledTask -TaskName "OneDrive ASWG Process Task" -Trigger $Stt -Action $Sta
